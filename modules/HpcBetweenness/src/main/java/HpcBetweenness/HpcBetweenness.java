 ...
 */
public class HpcBetweenness implements Statistics {
    //Result
    ...
    public void execute(GraphModel graphModel) {
        ...
        Column col = nodeTable.getColumn("Hpc Betweenness");
        if (col == null) {
            col = nodeTable.addColumn("Hpc Betweenness", Double.class);
        }
    ...
    public String getReport() {
        String report = "<HTML> <BODY> <h1>Hpc Betweenness Report </h1> "
                + "<hr>"
